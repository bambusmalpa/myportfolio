...
{name:"Aplikacja pogodowa", link:"https://bambusmalpa.github.io/React-Weather-App/",github:"https://github.com/bambusmalpa/React-Weather-App",foto:image02,desc:`Pomysł na aplikację pochodzi z warsztatów "FrontDev", pobiera dane z API, generuje wykresy prognozy pogody dla wybranych miast`,tech:[{color:"#e34f26",className:"fab fa-html5"},{color:"#0099e5",className:"fab fa-css3-alt"},{color:"#f7df1e",className:"fab fa-js"},{color:"#9933CC",className:"fab fa-bootstrap"},{color:"#00d8ff",className:"fab fa-react"}]},
...
{name:"Moje portfolio", link:"https://marcinkrawiecfrontend.netlify.com",github:"https://github.com/bambusmalpa/myportfolio",foto:image05,desc:`Moje portfolio, layout ma nawiązywać do edytora kodu Visual Sudio Code, kolorystyka zaczerpnięta z motywu "Dracula soft". W sekcji "contact" umieściłem customową mapkę wykonaną przy pomocy edytora Mapbox. `,tech:[{color:"#00d8ff",className:"fab fa-react"},{color:"#c51162",className:"fab fa-sass"},{color:"#0099e5",className:"fab fa-css3-alt"},{color:"#cc0000",className:"fas fa-file-image"},{color:"#e34f26",className:"fab fa-html5"}]},
